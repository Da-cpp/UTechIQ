  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      const storageFilePath =
        `${profile.id}/${Date.now()}_${targetFile.name}`;
      ...
      await fetch(
        'http://localhost:8000/api/v1/embeddings/process',
        {
          method: 'POST',
          headers: {
  ...
  const executeChatMessage = async (
    ...
    try {
      ...
      const assistantMsg: ChatMessage = {
        ...
        text:
          responseData.answer ||
          'RAG backend matrix returned no contextual tokens.',
        timestamp: new Date()
      };
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          sender: 'assistant',
          text:
            'Error interacting with core FastAPI RAG Engine.',
          timestamp: new Date()
        }
      ]);
    ...
    <div style={ragStyles.panelContainer}>
      ...
      <div style={ragStyles.identityBanner}>
        ...
        >
          ...
          <div>
            <h3 style={ragStyles.profileName}>
              {profile?.name || 'Academic Core Account'}
            </h3>

            <p style={ragStyles.profileMeta}>
              Verified Academic User Node
            </p>
          </div>
        </div>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <span style={ragStyles.idLabel}>
            Institutional ID Number
          </span>

          <span style={ragStyles.idValue}>
            {profile?.id_number || '2205034'}
          </span>
        ...
        <div style={ragStyles.chatFrame}>
          ...
          <div style={ragStyles.chatHeader}>
            ...
            >
              ...
              <span style={ragStyles.headerText}>
            ...
            {chatLoading && (
              ...
              <div style={ragStyles.messageRow}>
                ...
                >
                  ...
                  >
                    Computing vector weights context...
                  </span>
          ...
          <form
            onSubmit={executeChatMessage}
            style={ragStyles.inputForm}
          >
        ...
        {profile?.role === 'professor' && (
          ...
          <div style={ragStyles.sidebarFrame}>
            ...
            <div>
              ...
              <h3 style={ragStyles.sidebarTitle}>
                Session Bucket
              </h3>

              <p style={ragStyles.sidebarSub}>
                Drag & drop supplementary reference PDFs
                to expand active memory.
              </p>
            ...
            <label style={ragStyles.dropZone}>
              ...
              <span style={ragStyles.uploadText}>
            ...
            <div style={ragStyles.filesListContainer}>
              ...
              <span style={ragStyles.filesListHeader}>
              ...
              {sessionFiles.length === 0 ? (
                ...
                <div style={ragStyles.emptyStateBox}>
                  ...
                  <p style={ragStyles.emptyFilesText}>
                    No custom files attached to session.
                  </p>
